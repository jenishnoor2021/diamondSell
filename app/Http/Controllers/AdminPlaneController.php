...
class AdminPlaneController extends Controller
{
    ...
    {
        $planes = Plane::orderBy('id', 'DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        Plane::create($input);
        return redirect('admin/plane')->with('success', "Add Record Successfully");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $push->update($input);
        return redirect('admin/plane')->with('success', "Update Record Successfully");
    }
    ...
    public function planeActive($id)
    {
