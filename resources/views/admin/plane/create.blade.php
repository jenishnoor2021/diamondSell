      ...
      <div class="row">
         ...
         <div class="col-12">
            ...
            <div class="box box-info">
               ...
               <!-- /.box-header -->
               <!-- form start -->
               {!! Form::open(['method'=>'POST', 'action'=> 'AdminPlaneController@store','files'=>true,'class'=>'form-horizontal','name'=>'addplaneform']) !!}
               @csrf
               <div class="box-body">
                  <div class="form-group">
                     <label for="pname" class="col-sm-2 control-label">Name<span class="text-danger">*</span></label>
                     <div class="col-sm-4">
                        <input type="text" name="pname" class="form-control form-control-rounded" id="pname" placeholder="Enter plane Name" onkeypress='return (event.charCode != 32)' value="{{ old('pname') }}" required>
                        @if($errors->has('pname'))
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-4">
                        <input type="number" name="days" class="form-control form-control-rounded" id="days" placeholder="Enter days" value="{{ old('days') }}" required>
                        @if($errors->has('days'))
...
<script>
   $(function() {
      $("form[name='addplaneform']").validate({
         rules: {
            pname: {
               required: true,
            },
